...
// Enhanced Particles.js Configuration for Technology Theme
function initTechParticles() {
    particlesJS('particles-js', {
        particles: {
            ...
            color: { 
                value: ["#00ffff", "#00ff88", "#ff00ff", "#0088ff"] 
            },
            shape: { 
                type: "circle",
                stroke: {
...
window.addEventListener('load', function() {
    ...
    // Smooth scroll to existing hero section
...
// === NEW TOP HERO JS - ADD AT THE END ===
